...
class mainWin(jayspycom_win.com_win):
    ...
    def __init__(self, parent):
        jayspycom_win.com_win.__init__(self, parent)
        icon = wx.Icon()
        icon.CopyFromBitmap(wx.Bitmap( u"../img/jayspycom.ico", wx.BITMAP_TYPE_ANY))
        self.SetIcon(icon)
        #self.SetIcon(jayspycom.jayspycom.GetIcon())
...
if __name__ == '__main__':
    ...
    main_win.SetTitle(u"JaysPyCOM v1.0.0")
    main_win.Show()
